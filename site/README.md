...
site/
  ...
  main.js             Navigation, Kartenfilter, Einblendungen
  assets/img/         8 Bilder plus Logo und Favicons, auf Webgröße gerechnet
...
feste Navigation mit Links links, Wortmarke zentriert und Aktion rechts, transparent ueber dem
Vollbild und ab dem Scrollen cremefarben; Ueberschriften 60 px im Hero und 55 px in den
Bloecken mit Zeilenhoehe 0,95; Fliesstext 20 px; Kanten durchgehend ohne Rundung.
...
| 5 | Fusszeile | Navy mit Adresse, Zeiten, Kontakt | 0 |
...
| 4,9 Sterne bei 143 Bewertungen | Google, Stand 23.08.2026 |
| Öffnungszeiten, Adresse, Etage | Schlosshöfe-Website und Google |
| Telefon, E-Mail | Facebook-Seite |
| Rezensionen | Google, wörtlich zitiert |

**Fotos.** Es werden ausschließlich Bilder verwendet, die das Café selbst veröffentlicht hat,
also Facebook-Beiträge und die vom Inhaber bei Google hochgeladenen Fotos. Gästefotos aus
Google sind bewusst nicht dabei, weil die Rechte daran bei den Gästen liegen. KI-generierte
Motive wurden ebenfalls aussortiert.

**Technik.**

- Ein Farbklima für die ganze Seite, kein Wechsel mitten im Scrollen
- Vollbild-Hero mit eigenem Zuschnitt für Quer- und Hochformat
